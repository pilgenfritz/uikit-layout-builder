...
$tempURL = explode('js/cms/ckeditor/',$_SERVER['PHP_SELF']);
$config['BaseUrl'] = $tempURL[0] . 'img/ckeditor/';
...
//$tempDir = get
$tempDIR = explode('js/cms/ckeditor/',dirname(__FILE__));
$config['BaseDir'] = $tempDIR[0] . 'img/ckeditor/';

/*echo $config['BaseUrl'] . '<br/>';
echo $config['BaseDir'] . '<br/>';*/
