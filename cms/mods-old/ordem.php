...
function Main()
{
	...
	$query = "SELECT * FROM " . $db_table . " WHERE ORDER BY menu_order,nome";
	echo '
	<div class="row">
	  ...
	  <form method="post" action="index.php?on=' . $on . '">
	    ...
	    <fieldset>
		  ...
		  <div class="row">
		    ...
		    <div id="abrir-em" class="large-4 columns end">
				<div class="row">
			        ...
			        <div class="small-9 columns">
			            <select name="target">
				          <option value="_top"'; if($arr['target'] == '_top') echo ' selected'; echo '>Mesma página</option>
				          <option value="_blank"'; if($arr['target'] == '_blank') echo ' selected'; echo '>Nova Página</option>
				        </select>
			        </div>
			      </div>
		    </div>
...
function Salvar()
{
	global $admin, $admin_mods, $config, $on, $in, $db_table, $dontPost;
