	    ...
	    <fieldset>
		  ...
		  <div class="row">
		    <div class="large-12 columns">
		      <label>Título
		        <input type="text" id="texto" name="titulo" value="' . $arr['titulo'] . '" required />
		      </label>
		    </div>
		  </div>
		  <div class="row">
		    <div class="large-12 columns">
		      <label>Subtítulo
		        <input type="text" id="subtexto" name="subtitulo" value="' . $arr['subtitulo'] . '" />
		      </label>
		    </div>
		  </div>';
		  ...
		  <div class="row">
		    <div class="large-12 columns margintop20">
		      <label>Preço
		        <input type="text" id="preco" class="mask moeda" name="preco" value="' . $arr['preco'] . '" />
		      </label>
		    </div>
		  </div>
		  <div class="row">
		    <div class="large-12 columns">
		      <label>Texto do Botão
		        <input type="text" name="botao" value="' . $arr['botao'] . '" required />
		      </label>
		    </div>
		  </div>
		</fieldset>
