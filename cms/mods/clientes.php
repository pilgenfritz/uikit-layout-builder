		...
		<div class="columns large-12">';
			if(mysql_num_rows(mysql_query($query)) > 0)
			{
				...
				<table id="tabela_menu_img" class="list-table">
					<thead>
						<tr>
							<th>Imagens <span class="right disabled">Arraste para reordenar</span> </th>
						</tr>
					</thead>
					<tbody>
						<tr>
						  <td>
							...
							{
								echo '
								<div id="' . $arr['id'] . '" class="ui-state-default columns crop large-4 end'; if($arr['active'] != 'Y') echo ' inactive'; echo '">
	...
	<div class="row">
	  <form method="post" action="index.php?on=' . $on . '" enctype="multipart/form-data">
	    ...
	    <fieldset>
		  ...
		  <div class="row">
		    ...
		    if($admin->ModuloOptionsCheck($on,'cidade')){
			    echo '<div class="large-4 columns">
			      <label>Cidade
			        <input type="text" name="cidade" placeholder="Digite a cidade" value="' . $arr['cidade'] . '" required />
			      </label>
			    </div>';
		    }
		    echo '
		  ...
		  if($admin->ModuloOptionsCheck($on,'site')){
			  ...
			  <div class="row">
			    <div class="large-12 columns">
			      <br /><label>Site
			        <input type="text" name="site" placeholder="Cole link do site" value="' . $arr['site'] . '" />
			      </label>
			    </div>
			  </div>';
		  }
		  ...
		  if($admin->ModuloOptionsCheck($on,'servicos')){
			  echo '
			  <div class="row">
			    <div class="large-12 columns">
			      <label>Serviços realizados
			        <textarea id="servicos" name="servicos" cols="80" rows="10" class="ckeditor">' . $arr['servicos'] . '</textarea>
			      </label>
			    </div>
			  </div>';
		  }
		  if($admin->ModuloOptionsCheck($on,'depoimento')){
			  echo '
			  <div class="row">
			    <div class="large-12 columns">
			      <br/>
			      <label>Depoimento
			        <textarea id="depoimento" name="depoimento" cols="80" rows="10" class="ckeditor">' . $arr['depoimento'] . '</textarea>
			      </label>
			    </div>
			  </div>';
		  }
				...
				<div class="tabs-content show-code">
				  <div class="content active" id="panel2-1">
					...
					<div class="mod-options">
						...
						<label for="servicos">
							<input type="checkbox" name="servicos" id="servicos" value="Y" '; if($admin->ModuloOptionsCheck($on,'servicos')) echo ' checked'; echo '/> Servicos
						</label>
						<label for="depoimento">
							<input type="checkbox" name="depoimento" id="depoimento" value="Y" '; if($admin->ModuloOptionsCheck($on,'depoimento')) echo ' checked'; echo '/> Depoimento
						</label>
						<label for="galeria">
