		...
		<div class="columns large-12">';
			if(mysql_num_rows(mysql_query($query)) > 0)
			{
				...
				<table class="list-table">
					...
					{
						echo '
						<tr id="' . $arr['id'] . '" class="'; if($arr['active'] != 'Y') echo ' inactive'; echo '">';
				  ...
				  <div class="content" id="panel2-2">
				    <pre>
						<code>';
							...
							.'  $' . $on . ' .= \''."\r\n"
							.'  <div class="row">'."\r\n"
							.'    <div class="columns large-3 three">'."\r\n"
							.'      <a href="' . $on . '/\' . $arr[\'id\'] . \'/\' . $Dados->create_slug($arr[\'titulo\']) . \'">'."\r\n"
							.'        <img src="img/' . $on . '/\' . $arr[\'img1\'] . \'" alt="\' . $arr[\'titulo\'] . \'" />'."\r\n"
							.'      </a>'."\r\n"
							.'    </div>'."\r\n"
							.'    <div class="columns large-9 nine">'."\r\n"
							.'      <p>'."\r\n"
							.'        <a href="' . $on . '/\' . $arr[\'id\'] . \'/\' . $Dados->create_slug($arr[\'titulo\']) . \'">'."\r\n"
							.'        \' . $arr[\'titulo\'] . \''."\r\n"
							.'        </a>'."\r\n"
