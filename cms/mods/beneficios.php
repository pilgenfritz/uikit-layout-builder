	    ...
	    <fieldset>
		  ...
		  <div class="row">
		    <div class="large-12 columns">
		      <label>Título';
		      if($on != 'estudos_de_mercado')
		      {
			      echo '
			        <textarea id="texto" name="titulo" cols="80" rows="10" class="ckeditor" required>' . $arr['titulo'] . '</textarea>';
		      }else
		      {
		      	  echo '<input type="text" id="texto" name="titulo" required value="' . $arr['titulo'] . '" />';
		      }
		      echo '
		      </label>
		    </div>
